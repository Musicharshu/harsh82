...
**ᴘᴏᴡʀᴇᴅ © ʙʏ** @Insane_Help365, @InsaneSupport365 @Dosto_ki_Mehfil786."""
...
**ᴘᴏᴡʀᴇᴅ © ʙʏ** @chatting_gruap, @chatting_gruap @chatting_gruap."""
...
/alive : ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴄʜᴇᴄᴋ Insane ᴍᴜsɪᴄ ʙᴏᴛ ɪs ᴀʟɪᴠᴇ ᴏʀ ɴᴏᴛ
