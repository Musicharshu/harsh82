#
# Copyright (C) 2021-2022 by Insane_Help365@Github, < https://github.com/Musicharshu >.
# #

# Kanged By © @chatting_gruap
# alone © @chatting_gruap
# Owner harsh
...
from InsaneMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from InsaneMusic.core.call import Insane
from InsaneMusic.utils import seconds_to_min, time_to_seconds
from InsaneMusic.utils.channelplay import get_channeplayCB
from InsaneMusic.utils.database import is_video_allowed
from InsaneMusic.utils.decorators.language import languageCB
from InsaneMusic.utils.decorators.play import PlayWrapper
from InsaneMusic.utils.formatters import formats
from InsaneMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from InsaneMusic.utils.inline.playlist import botplaylist_markup
from InsaneMusic.utils.logger import play_logs
from InsaneMusic.utils.stream.stream import stream
...
@app.on_callback_query(filters.regex("InsanePlaylists") & ~BANNED_USERS)
@languageCB
