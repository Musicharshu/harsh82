...
# Owner harsh 
# All rights reserved. © Alisha © harsh © Insane
...
from InsaneMusic.misc import SUDOERS, db
...
from InsaneMusic.utils.formatters import seconds_to_min
from InsaneMusic.utils.inline.play import panel_markup_1, stream_markup, telegram_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Insane.mute_stream(chat_id)
