...
from InsaneMusic.utils.database import get_authuser_names, get_cmode
from InsaneMusic.utils.decorators import ActualAdminCB, AdminActual, language
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Insane.stop_stream(message.chat.id)
    except:
        pass
