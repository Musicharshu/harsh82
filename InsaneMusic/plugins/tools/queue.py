...
from InsaneMusic.utils import Insanebin, get_channeplayCB, seconds_to_min
from InsaneMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from InsaneMusic.utils.decorators.language import language, languageCB
from InsaneMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/e5938d9ca8fb7c2724f80.jpg",
        caption=_["queue_1"],
    )
